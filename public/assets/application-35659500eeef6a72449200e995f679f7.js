...
(function() {
  $(function() {
    return $('#content_summernote').summernote({
      height: 400
    });
  });
...
(function() {
  $(function() {
    ...
    if (namespace.controller === "lists" && namespace.action === "edit") {
      $('#add_checkbox').click(function(e) {
        ...
        if (window.cur_position === main_list) {
          return main_list.append("<li> <span class='form-group list_item'> <input type='checkbox' class=''/> " + ($('#new_item_text').val()) + " </span> <i class='fa fa-times-circle'></i> </li>");
        } else {
          return window.cur_position.after("<li> <span class='form-group list_item'> <input type='checkbox' class=''/> " + ($('#new_item_text').val()) + " </span> <i class='fa fa-times-circle'></i> </li>");
        }
      });
      ...
      $('#add_text').click(function(e) {
        e.preventDefault();
        return main_list.append("<li class='list_item'><span style='font-weight:bold; font-size:1.2em'> " + ($('#new_item_text').val()) + " </span><i class='fa fa-times-circle'></i></li>");
      });
      $('#add_break').click(function(e) {
        e.preventDefault();
        return window.cur_position.after("<li><i class='fa fa-times-circle'></i></li>");
      });
    }
    $(document).on('click', '.list_item', function() {
      ...
      if (namespace.controller === "lists" && namespace.action === "edit") {
        console.log($(this));
        console.log(window.cur_position[0]);
        if (window.cur_position[0] === $(this)[0]) {
          ...
          window.cur_position = $(this)[0];
          console.log(window.cur_position);
          return $(this).css('background-color', 'aqua');
        }
      }
    });
