...
(function() {
  $(function() {
    ...
    if (namespace.controller === "blog_posts" && namespace.action === "index") {
      return new List('blog_posts', {
...
(function() {
  $(function() {
    var timeout_hide_alerts;
    timeout_hide_alerts = function() {
      return $(document).find('.alert.fade.in').fadeOut(500);
    };
    return setTimeout(timeout_hide_alerts, 2000);
  });

}).call(this);
(function() {
  $(function() {
    if (namespace.controller === "lists" && namespace.action === "index") {
      new List('lists', {
        valueNames: ['title', 'owner', 'date', 'completeness']
      });
    }
    window.list_body = $('#list_body');
    if (namespace.controller === "lists" && namespace.action === "edit") {
      $("#list_body").sortable();
      $(document).on('dblclick', '.editable', function(e) {
        ...
        if (!$(this).hasClass('editing')) {
          ...
          return $(this).html("<i class='fa fa-floppy-o save-edit'></i><input class='edit-box' type='text' value='" + old + "'/>");
        }
      });
      $(document).on('click', '.save-edit', function(e) {
        $(this).parents('.editable').removeClass('editing');
        return $(this).parents('.editable').html($(this).siblings('input').val());
      });
    }
    $('#add_checkbox').click(function(e) {
      ...
      position.append("<div class='checklist-item'> <i class='fa fa-square-o checkbox'></i> <text class='editable'>" + ($('#new_item_text').val()) + "</text> <i class='fa fa-times-circle delete-checklist-item'></i> </div>");
      return $('#new_item_text').val('');
    });
    $('#add_sublist').click(function(e) {
      e.preventDefault();
      list_body.append("<div class='sublist'> <div class='sublist-title'> <text class='editable'>" + ($('#new_item_text').val()) + "</text> <i class='fa fa-times-circle delete-sublist-item'></i> </div> <ul class='sublist-list'></ul> </div>");
      return $('#new_item_text').val('');
    });
    $(document).on('click', '.sublist-title', function(e) {
      if ($(this).hasClass('cursor')) {
        $(this).css('background-color', 'white');
        $('.cursor').removeClass('cursor');
        return window.list_body.addClass('cursor');
      } else {
        $('.cursor').css('background-color', 'white');
        $('.cursor').removeClass('cursor');
        $(this).css('background-color', 'aqua');
        return $(this).addClass('cursor');
      }
    });
    ...
    $(document).on('click', '.delete-checklist-item', function(e) {
      var x;
      x = $(this).parents('div.checklist-item');
      x.fadeOut(250);
      return x.remove();
    });
    $(document).on('click', '.delete-sublist-item', function(e) {
      var x;
      e.stopPropagation();
    ...
    window.calculate_completeness = function() {
      var completeness, num_checkboxes, num_checked;
    ...
    $('#save_button').click(function(e) {
      ...
      $('.editing').each(function() {
        return $(this).find('.save-edit').trigger('click');
      });
      $('i.fa-times-circle').each(function() {
        return $(this).show();
      });
      $('.cursor').css('background-color', 'white');
      $('.cursor').removeClass('cursor');
      ...
      return $('.edit_list').submit();
    });
    $('#cancel_button').click(function(e) {
      e.preventDefault();
      return location.reload();
    });
    $(document).on('keypress', '.edit-box', function(e) {
      if (e.keyCode === 13) {
        $(this).siblings('.save-edit').trigger('click');
        return false;
      }
    });
    if (namespace.controller === "lists" && namespace.action === "show") {
      return $('i.fa-times-circle').each(function() {
        return $(this).hide();
      });
    }
  });
